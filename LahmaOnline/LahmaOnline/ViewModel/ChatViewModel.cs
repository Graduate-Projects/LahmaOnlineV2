    ...
    public class ChatViewModel : INotifyPropertyChanged
    {
        ...
        public ChatViewModel()
        {
            ...
            if(Device.RuntimePlatform == Device.Android)
                ...
                .WithUrl($"https://192.168.0.104:5000/chatHub")
                .Build();
            else
            if (Device.RuntimePlatform == Device.UWP)
                hubConnection = new HubConnectionBuilder()
                .WithUrl($"https://localhost:52352/chatHub")
                .Build();
            ...
            {
                Messages.Add(new MessageModel() { User = user, Message = message, IsSystemMessage = Name != user, IsOwnMessage = Name == user });
            });
        }
