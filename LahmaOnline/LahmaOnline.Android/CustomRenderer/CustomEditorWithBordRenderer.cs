...
[assembly: ExportRenderer(typeof(CustomEditorWithBord), typeof(CustomEditorWithBordRenderer))]
#pragma warning restore CS0612 // Type or member is obsolete
namespace LahmaOnline.Droid.CustomRenderer
{
    [Obsolete]
    public class CustomEditorWithBordRenderer: EditorRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Editor> e)
        {
            ...
            if (e.NewElement != null)
            {
                ...
                var view = (CustomEditorWithBord)Element;
